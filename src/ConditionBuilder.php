 ...
 * @method isBetween( $field,  $start,  $end );
 * @method isEqual( $leftOperand,  $rightOperand );
 * @method isGreater( $left,  $right );
 * @method isGreaterOrEqual( $left,  $right );
 * @method isLess( $left,  $right );
 * @method isLessOrEqual( $left,  $right );
 * @method isLike( $left,  $right );
 * @method isNotEqual( $leftOperand,  $rightOperand );
 * @method isNotLike( $left,  $right );
 * @method isNotNull( $field, bool $mustBeConsidered = true );
 * @method isNull( $field, bool $mustBeConsidered = true );
 * </autogenerated-methods>
 */
class ConditionBuilder implements OperatorInterface
{
    ...
    public function __call($name, $arguments): ConditionBuilder
    {
        $className = __NAMESPACE__ . '\\Operator\\' . ucfirst($name);
